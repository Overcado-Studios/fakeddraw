...
HRESULT WINAPI IDirect3DDeviceFake_GetCaps( IDirect3DDeviceFake* This,  LPD3DDEVICEDESC7 lpD3DDevDesc )
{
	...
	/* TODO: Fully fill this out based on the actual GPU's capabilities, no guesswork */

	memset( &lpD3DDevDesc, 0, sizeof( D3DDEVICEDESC7 ) );
	lpD3DDevDesc->dwDevCaps = D3DDEVCAPS_CANBLTSYSTONONLOCAL | 
	...
	lpD3DDevDesc->dpcTriCaps.dwRasterCaps = D3DPRASTERCAPS_ZBUFFERLESSHSR | D3DPRASTERCAPS_FOGTABLE | D3DPRASTERCAPS_FOGVERTEX;
	lpD3DDevDesc->dpcLineCaps.dwDestBlendCaps |= D3DPBLENDCAPS_SRCCOLOR;
	lpD3DDevDesc->dpcLineCaps.dwSrcBlendCaps |= D3DPBLENDCAPS_DESTCOLOR;

	lpD3DDevDesc->dwDeviceRenderBitDepth = DDBD_32;
	lpD3DDevDesc->wMaxTextureBlendStages = 8;
	lpD3DDevDesc->dwTextureOpCaps = D3DTEXOPCAPS_ADD | D3DTEXOPCAPS_MODULATE | D3DTEXOPCAPS_MODULATE2X | D3DTEXOPCAPS_ADDSIGNED;
